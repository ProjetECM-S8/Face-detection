...
video_path = '/Users/Guangyi/ProjetS8/video3 (640_360).mp4'

#video_path = '/Users/Guangyi/ProjetS8/Manif.mp4'
...
for i in range(num_frames):
    ...
    info = [
        ('number of faces detected', '{}'.format(len(rectangles))),
        ('FPS:',"{}".format(fps)),
        ('Time spent in s',"{}".format(seconds))
    ]

    for (i, (txt, val)) in enumerate(info):
        text = '{}: {}'.format(txt, val)
        cv2.putText(draw, text, (10, (i * 20) + 20),
